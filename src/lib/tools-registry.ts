        ...
        tools: [
            {
                ...
                status: 'active',
                keywords: ['fit', 'size', 'kb', '20kb', '100kb', '200kb', '300kb', 'upsc', 'epfo', 'kyc', 'form'],
            ...
            },
            {
                ...
                color: { text: 'text-blue-600', bg: 'bg-blue-50', hex: '#026EFF' },
                status: 'active',
                keywords: ['passport', 'photo', 'seva', 'icao', '630', 'kyc', 'upsc'],
                offlineSupported: true,
                premium: false,
                priority: 108,
            },
            {
                ...
                color: { text: 'text-blue-600', bg: 'bg-blue-50', hex: '#026EFF' },
                status: 'active',
                keywords: ['background', 'remove', 'white bg', 'kyc', 'passport'],
                offlineSupported: true,
                premium: false,
                priority: 106,
            },

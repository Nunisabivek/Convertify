        ...
        tools: [
            {
                id: 'fit-to-size',
                name: 'Fit to size',
                description: 'Make a PDF or photo land between a min and max KB or MB.',
                icon: { lucide: 'Gauge', material: 'straighten' },
                href: 'fit-to-size',
                color: { text: 'text-blue-600', bg: 'bg-blue-50', hex: '#026EFF' },
                status: 'active',
                keywords: ['fit', 'size', 'kb', '20kb', '100kb', '200kb', '300kb', 'upsc', 'epfo', 'kyc', 'form', 'job portal', 'university', '1mb', '2mb'],
            ...
            },
            {
                id: 'passport-photo',
                name: 'Passport photo',
                description: 'US 2×2, India 630×810, visa 35×45, bank and signature JPEGs.',
                icon: { lucide: 'UserRound', material: 'portrait' },
                href: 'passport-photo',
                color: { text: 'text-blue-600', bg: 'bg-blue-50', hex: '#026EFF' },
                status: 'active',
                keywords: ['passport', 'photo', 'seva', 'icao', '630', 'kyc', 'upsc', '2x2', '600x600', 'us passport', 'visa photo', 'schengen'],
                offlineSupported: true,
                premium: false,
                priority: 108,
            },
            {
                ...
                name: 'Background',
                description: 'White or light-blue backdrop for passport, KYC, and LinkedIn.',
                icon: { lucide: 'Eraser', material: 'auto_fix_high' },
                href: 'remove-background',
                color: { text: 'text-blue-600', bg: 'bg-blue-50', hex: '#026EFF' },
                status: 'active',
                keywords: ['background', 'remove', 'white bg', 'kyc', 'passport', 'linkedin', 'headshot', 'id photo'],
                offlineSupported: true,
                premium: false,
                priority: 106,
            },
    ...
    },
{
    ...
    },
    {
        ...
        tools: [
            ...
            },
            {
                id: 'svg-to-png',
                name: 'SVG to PNG',
                description: 'Convert vector SVG files to PNG images.',
                icon: { lucide: 'FileImage', material: 'image' },
                href: 'svg-to-png',
                color: { text: 'text-indigo-600', bg: 'bg-indigo-50', hex: '#4F46E5' },
                status: 'active',
                keywords: ['svg', 'png', 'vector', 'convert', 'rasterize'],
                offlineSupported: true,
                premium: false,
                priority: 70,
            },
            {
                id: 'bmp-to-jpg',
                name: 'BMP to JPG',
                description: 'Convert BMP bitmap images to JPG.',
                icon: { lucide: 'Image', material: 'image' },
                href: 'bmp-to-jpg',
                color: { text: 'text-amber-600', bg: 'bg-amber-50', hex: '#D97706' },
                status: 'active',
                keywords: ['bmp', 'bitmap', 'jpg', 'jpeg', 'convert'],
                offlineSupported: true,
                premium: false,
                priority: 65,
            },
            {
                ...
                icon: { lucide: 'Image', material: 'gif' },
                href: 'gif-to-png',
                color: { text: 'text-pink-600', bg: 'bg-pink-50', hex: '#DB2777' },
                status: 'active',
                keywords: ['gif', 'png', 'convert', 'static', 'frame'],
                offlineSupported: true,
                premium: false,
                priority: 60,
            },
            {
                ...
                icon: { lucide: 'FileImage', material: 'picture_as_pdf' },
                href: 'tiff-to-pdf',
                color: { text: 'text-slate-600', bg: 'bg-slate-50', hex: '#475569' },
                status: 'active',
                keywords: ['tiff', 'tif', 'pdf', 'scan', 'document'],
                offlineSupported: true,
                premium: false,
                priority: 55,
            },
    ...
    },
    {
        ...
        tools: [
            ...
            {
                id: 'autocad-pdf-editor',
                name: 'Edit AutoCAD PDF',
                description: 'Edit SHX vector text in AutoCAD-exported PDFs.',
                icon: { lucide: 'Ruler', material: 'architecture' },
                href: 'autocad-pdf-editor',
                color: { text: 'text-orange-600', bg: 'bg-orange-50', hex: '#EA580C' },
                status: 'active',
                keywords: ['autocad', 'cad', 'shx', 'dwg', 'blueprint', 'dimension', 'edit', 'vector text'],
                offlineSupported: true,
                premium: false,
                priority: 84,
            },
        ...
        tools: [
            {
                ...
                icon: { lucide: 'FileJson', material: 'data_object' },
                href: 'csv-to-json',
                color: { text: 'text-emerald-600', bg: 'bg-emerald-50', hex: '#059669' },
                status: 'active',
                keywords: ['csv', 'json', 'data', 'convert', 'api', 'developer'],
                offlineSupported: true,
                premium: false,
                priority: 90,
            },
            {
                ...
                icon: { lucide: 'FileSpreadsheet', material: 'table_chart' },
                href: 'json-to-csv',
                color: { text: 'text-blue-600', bg: 'bg-blue-50', hex: '#2563EB' },
                status: 'active',
                keywords: ['json', 'csv', 'spreadsheet', 'data', 'export'],
                offlineSupported: true,
                premium: false,
                priority: 85,
            },
            {
                ...
                icon: { lucide: 'FileCode', material: 'code' },
                href: 'xml-to-json',
                color: { text: 'text-orange-600', bg: 'bg-orange-50', hex: '#EA580C' },
                status: 'active',
                keywords: ['xml', 'json', 'data', 'convert', 'api'],
                offlineSupported: true,
                premium: false,
                priority: 80,
            },
            {
                ...
                color: { text: 'text-violet-600', bg: 'bg-violet-50', hex: '#7C3AED' },
                status: 'active',
                keywords: ['markdown', 'md', 'pdf', 'document', 'github'],
                offlineSupported: true,
                premium: false,
                priority: 75,
            },
            {
                ...
                icon: { lucide: 'Binary', material: 'enhanced_encryption' },
                href: 'base64',
                color: { text: 'text-gray-600', bg: 'bg-gray-50', hex: '#4B5563' },
                status: 'active',
            ...
            },
            {
                ...
                description: 'Create QR codes from URLs, text, and data.',
                icon: { lucide: 'QrCode', material: 'qr_code' },
                href: 'qr-code-generator',
                color: { text: 'text-slate-600', bg: 'bg-slate-50', hex: '#475569' },
                status: 'active',
                keywords: ['qr', 'qr code', 'barcode', 'generate', 'scan'],
                offlineSupported: true,
                premium: false,
                priority: 95,
            },

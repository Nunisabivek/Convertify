...
const LEADS: Record<string, string> = {
    ...
    'passport-photo': 'Passport, bank photo, signature, or thumb. Crop, then we hit the KB a form asks for.',
    ...
    'compress-pdf': 'Type any KB. We lower quality first and only shrink pixels if we have to.',
    ...
    'image-compressor': 'Type a target KB. Quality first, then a smaller photo only if needed.',

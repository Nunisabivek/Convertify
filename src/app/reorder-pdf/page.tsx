        ...
        <div className="flex flex-col items-center">
            ...
            <BreadcrumbSchema 
                items={[
                    ...
                    { name: "Reorder PDF", url: "/reorder-pdf" }
                ]}
            />
            <SoftwareApplicationSchema
                toolName="Convertify PDF Page Reorder Tool"
            ...
            {seoData.howToSteps && (
                <HowToSchema
                    ...
                    description="Learn how to rearrange and reorder PDF pages online with Convertify."
            ...
            <ToolDeepGuide toolSlug="reorder-pdf" toolName="Reorder PDF Online" />
            <RelatedUseCases toolHref="/reorder-pdf" />

...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://convertify.work/how-to-split-pdf-by-page-number",
  },
  openGraph: {
    title: "How to Split PDF by Page Number - Extract Specific Pages Free",
    description: "Extract specific pages from PDF by page number. Split one PDF into multiple files or extract individual pages online for free.",
    url: "/how-to-split-pdf-by-page-number",
    images: [
      {
        url: "/images/og-banner.png",
        width: 1200,
        height: 630,
        alt: "How to Split PDF by Page Number - Extract Specific Pages Free",
      },
    ],
  },
}
    ...
    <div className="flex flex-col items-center">
      ...
      <BreadcrumbSchema 
        items={[
          ...
          { name: "Split PDF by Page Number (Free Online Tool)", url: "/how-to-split-pdf-by-page-number" }
        ]}
      />
      ...
      <section className="w-full py-12 bg-gradient-to-b from-blue-50 to-white">
        <div className="max-w-4xl mx-auto px-4">
          <h1 className="text-4xl md:text-5xl font-extrabold text-slate-900 mb-4 text-center">
            Split PDF by Page Number (Free Online Tool)
          </h1>
          <p className="text-xl text-slate-600 max-w-3xl mx-auto mb-8 text-center">
            Extract specific pages from PDF by page number. Split one PDF into multiple files or extract individual pages online for free.
          </p>
      ...
      <section className="w-full py-12 bg-white">
        <div className="max-w-4xl mx-auto px-4">
          <div className="prose prose-lg max-w-none">
            ...
            <ol>
              <li>
                <strong>Open the Tool:</strong> Visit <Link href="/split-pdf" className="text-indigo-600 hover:underline">Convertify's free tool</Link> in any web browser.
              </li>
              <li>
      ...
      <HowToSchema
        toolName="Split PDF by Page Number (Free Online Tool)"
        description="Extract specific pages from PDF by page number. Split one PDF into multiple files or extract individual pages online for free."
        steps={howToSteps}
      />

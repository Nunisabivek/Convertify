...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://convertify.work/how-to-convert-pdf-to-word-editable",
  },
  openGraph: {
    title: "How to Convert PDF to Editable Word Document Free",
    description: "Turn PDF into editable Word document while preserving formatting. Free PDF to DOCX converter with OCR support.",
    url: "/how-to-convert-pdf-to-word-editable",
    images: [
      {
        url: "/images/og-banner.png",
        width: 1200,
        height: 630,
        alt: "How to Convert PDF to Editable Word Document Free",
      },
    ],
  },
}
    ...
    <div className="flex flex-col items-center">
      ...
      <BreadcrumbSchema 
        items={[
          ...
          { name: "Convert PDF to Editable Word Document", url: "/how-to-convert-pdf-to-word-editable" }
        ]}
      />
      ...
      <section className="w-full py-12 bg-gradient-to-b from-blue-50 to-white">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <p className="text-xl text-slate-600 max-w-3xl mx-auto mb-8 text-center">
            Turn PDF into editable Word document while preserving formatting. Free PDF to DOCX converter with OCR support.
          </p>
      ...
      <section className="w-full py-12 bg-white">
        <div className="max-w-4xl mx-auto px-4">
          <div className="prose prose-lg max-w-none">
            ...
            <ol>
              <li>
                <strong>Open the Tool:</strong> Visit <Link href="/pdf-to-word" className="text-indigo-600 hover:underline">Convertify's free tool</Link> in any web browser.
              </li>
              <li>
      ...
      <HowToSchema
        toolName="Convert PDF to Editable Word Document"
        description="Turn PDF into editable Word document while preserving formatting. Free PDF to DOCX converter with OCR support."
        steps={howToSteps}
      />

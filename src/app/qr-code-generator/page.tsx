...
export const metadata: Metadata = {
    title: appToolTitle('qr-code-generator', seoData.title),
...
export default function Page() {
    if (IS_MOBILE_BUILD) return <MobileToolFrame toolId="qr-code-generator"><QrCodeClient /></MobileToolFrame>
    ...
    return (
        <div className="flex flex-col items-center">
            ...
            <ToolDeepGuide toolSlug="qr-code-generator" toolName="QR Code Generator" />

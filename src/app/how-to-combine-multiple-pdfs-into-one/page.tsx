...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://convertify.work/how-to-combine-multiple-pdfs-into-one",
  },
  openGraph: {
    title: "How to Combine Multiple PDFs into One Document Free",
    description: "Merge unlimited PDF files into a single document. Drag and drop to reorder pages. No watermarks, no file limits.",
    url: "/how-to-combine-multiple-pdfs-into-one",
    images: [
      {
        url: "/images/og-banner.png",
        width: 1200,
        height: 630,
        alt: "How to Combine Multiple PDFs into One Document Free",
      },
    ],
  },
}
    ...
    <div className="flex flex-col items-center">
      ...
      <BreadcrumbSchema 
        items={[
          ...
          { name: "Combine Multiple PDFs into One Document", url: "/how-to-combine-multiple-pdfs-into-one" }
        ]}
      />
      ...
      <section className="w-full py-12 bg-gradient-to-b from-blue-50 to-white">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <p className="text-xl text-slate-600 max-w-3xl mx-auto mb-8 text-center">
            Merge unlimited PDF files into a single document. Drag and drop to reorder pages. No watermarks, no file limits.
          </p>
      ...
      <HowToSchema
        toolName="Combine Multiple PDFs into One Document"
        description="Merge unlimited PDF files into a single document. Drag and drop to reorder pages. No watermarks, no file limits."
        steps={howToSteps}
      />

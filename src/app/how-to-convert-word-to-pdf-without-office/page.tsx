...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://convertify.work/how-to-convert-word-to-pdf-without-office",
  },
  openGraph: {
    title: "How to Convert Word to PDF Without Microsoft Office",
    description: "Convert DOCX to PDF free without Microsoft Office installed. Works on Windows, Mac, and Linux. No software required.",
    url: "/how-to-convert-word-to-pdf-without-office",
    images: [
      {
        url: "/images/og-banner.png",
        width: 1200,
        height: 630,
        alt: "How to Convert Word to PDF Without Microsoft Office",
      },
    ],
  },
}
    ...
    <div className="flex flex-col items-center">
      ...
      <BreadcrumbSchema 
        items={[
          ...
          { name: "Convert Word to PDF Without Microsoft Office", url: "/how-to-convert-word-to-pdf-without-office" }
        ]}
      />
      ...
      <section className="w-full py-12 bg-gradient-to-b from-blue-50 to-white">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <p className="text-xl text-slate-600 max-w-3xl mx-auto mb-8 text-center">
            Convert DOCX to PDF free without Microsoft Office installed. Works on Windows, Mac, and Linux. No software required.
          </p>
      ...
      <section className="w-full py-12 bg-white">
        <div className="max-w-4xl mx-auto px-4">
          <div className="prose prose-lg max-w-none">
            ...
            <ol>
              <li>
                <strong>Open the Tool:</strong> Visit <Link href="/word-to-pdf" className="text-indigo-600 hover:underline">Convertify's free tool</Link> in any web browser.
              </li>
              <li>
      ...
      <HowToSchema
        toolName="Convert Word to PDF Without Microsoft Office"
        description="Convert DOCX to PDF free without Microsoft Office installed. Works on Windows, Mac, and Linux. No software required."
        steps={howToSteps}
      />

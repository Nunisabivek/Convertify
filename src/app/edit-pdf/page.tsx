...
const seoData = toolSeoData["edit-pdf"]
...
export const metadata: Metadata = {
    ...
    alternates: {
        canonical: "https://convertify.work/edit-pdf",
    },
    openGraph: {
        title: seoData.title,
        description: seoData.description,
    ...
    return (
        <div className="flex flex-col items-center">
            ...
            <SoftwareApplicationSchema
                toolName="Convertify PDF Editor"
                toolSlug="edit-pdf"
                description={seoData.description}
            />
            ...
            {seoData.howToSteps && (
                <HowToSchema
                    toolName="Edit PDF"
                    description="Learn how to edit PDF text, add annotations, draw, and stamp documents online for free with Convertify."
            ...
            <ToolDeepGuide toolSlug="edit-pdf" />

            <RelatedUseCases toolHref="/edit-pdf" />

            <RelatedTools currentTool="/edit-pdf" />
        </div>
    )
}

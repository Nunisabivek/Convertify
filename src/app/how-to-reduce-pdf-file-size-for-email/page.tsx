...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://convertify.work/how-to-reduce-pdf-file-size-for-email",
  },
  openGraph: {
    title: "How to Reduce PDF File Size for Email - Beat 25MB Limit",
    description: "Compress large PDF files to fit Gmail's 25MB attachment limit. Reduce PDF size by up to 90% without losing quality.",
    url: "/how-to-reduce-pdf-file-size-for-email",
    images: [
      {
        url: "/images/og-banner.png",
        width: 1200,
        height: 630,
        alt: "How to Reduce PDF File Size for Email - Beat 25MB Limit",
      },
    ],
  },
}
    ...
    <div className="flex flex-col items-center">
      ...
      <BreadcrumbSchema 
        items={[
          ...
          { name: "Reduce PDF File Size for Email Attachments", url: "/how-to-reduce-pdf-file-size-for-email" }
        ]}
      />
      ...
      <section className="w-full py-12 bg-gradient-to-b from-blue-50 to-white">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <p className="text-xl text-slate-600 max-w-3xl mx-auto mb-8 text-center">
            Compress large PDF files to fit Gmail's 25MB attachment limit. Reduce PDF size by up to 90% without losing quality.
          </p>
      ...
      <HowToSchema
        toolName="Reduce PDF File Size for Email Attachments"
        description="Compress large PDF files to fit Gmail's 25MB attachment limit. Reduce PDF size by up to 90% without losing quality."
        steps={howToSteps}
      />

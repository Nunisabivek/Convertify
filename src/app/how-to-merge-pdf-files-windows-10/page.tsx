...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://convertify.work/how-to-merge-pdf-files-windows-10",
  },
  openGraph: {
    title: "How to Merge PDF Files on Windows 10 Without Software",
    description: "Learn how to combine multiple PDF files on Windows 10 for free. No software installation required. Works with Windows 11 too.",
    url: "/how-to-merge-pdf-files-windows-10",
    images: [
      {
        url: "/images/og-banner.png",
        width: 1200,
        height: 630,
        alt: "How to Merge PDF Files on Windows 10 Without Software",
      },
    ],
  },
}
    ...
    <div className="flex flex-col items-center">
      ...
      <BreadcrumbSchema 
        items={[
          ...
          { name: "How to Merge PDF Files on Windows 10 (Free Method)", url: "/how-to-merge-pdf-files-windows-10" }
        ]}
      />
      ...
      <section className="w-full py-12 bg-gradient-to-b from-blue-50 to-white">
        <div className="max-w-4xl mx-auto px-4">
          <h1 className="text-4xl md:text-5xl font-extrabold text-slate-900 mb-4 text-center">
            How to Merge PDF Files on Windows 10 (Free Method)
          </h1>
          <p className="text-xl text-slate-600 max-w-3xl mx-auto mb-8 text-center">
            Learn how to combine multiple PDF files on Windows 10 for free. No software installation required. Works with Windows 11 too.
          </p>
      ...
      <section className="w-full py-12 bg-white">
        <div className="max-w-4xl mx-auto px-4">
          <div className="prose prose-lg max-w-none">
            ...
            <ol>
              <li>
                <strong>Open the Tool:</strong> Visit <Link href="/merge-pdf" className="text-indigo-600 hover:underline">Convertify's free tool</Link> in any web browser.
              </li>
              <li>
      ...
      <HowToSchema
        toolName="How to Merge PDF Files on Windows 10 (Free Method)"
        description="Learn how to combine multiple PDF files on Windows 10 for free. No software installation required. Works with Windows 11 too."
        steps={howToSteps}
      />

...
export const metadata: Metadata = {
    title: toolDocumentTitle("heic-to-jpg", "HEIC to JPG Converter - Convert iPhone Photos Free | Convertify"),
...
export default function Page() {
    if (IS_MOBILE_BUILD) return <MobileToolFrame toolId="heic-to-jpg"><HeicToJpgClient /></MobileToolFrame>

    const relatedBlogSlugs = getBlogPostsForTool('heic-to-jpg')

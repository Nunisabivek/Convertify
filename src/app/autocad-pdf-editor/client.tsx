...
export default function AutocadPdfEditorClient() {
    ...
    const handleExport = async () => {
        ...
        // The popunder ad is deferred on this route — fire it now (export time) from
        // within the user's click gesture, so it isn't triggered mid-edit.
        try {
            ;(window as unknown as { __convertifyLoadPopunder?: () => void }).__convertifyLoadPopunder?.()
        } catch {
            /* ad loader optional */
        }
        setStep("exporting")

...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://convertify.work/how-to-convert-excel-to-pdf-free",
  },
  openGraph: {
    title: "How to Convert Excel to PDF Free - Preserve Formatting",
    description: "Convert XLS and XLSX spreadsheets to PDF while keeping charts, formulas, and formatting intact. No Excel required.",
    url: "/how-to-convert-excel-to-pdf-free",
    images: [
      {
        url: "/images/og-banner.png",
        width: 1200,
        height: 630,
        alt: "How to Convert Excel to PDF Free - Preserve Formatting",
      },
    ],
  },
}
    ...
    <div className="flex flex-col items-center">
      ...
      <BreadcrumbSchema 
        items={[
          ...
          { name: "Convert Excel to PDF Free (No Software)", url: "/how-to-convert-excel-to-pdf-free" }
        ]}
      />
      ...
      <section className="w-full py-12 bg-gradient-to-b from-blue-50 to-white">
        <div className="max-w-4xl mx-auto px-4">
          <h1 className="text-4xl md:text-5xl font-extrabold text-slate-900 mb-4 text-center">
            Convert Excel to PDF Free (No Software)
          </h1>
          <p className="text-xl text-slate-600 max-w-3xl mx-auto mb-8 text-center">
            Convert XLS and XLSX spreadsheets to PDF while keeping charts, formulas, and formatting intact. No Excel required.
          </p>
      ...
      <section className="w-full py-12 bg-white">
        <div className="max-w-4xl mx-auto px-4">
          <div className="prose prose-lg max-w-none">
            ...
            <ol>
              <li>
                <strong>Open the Tool:</strong> Visit <Link href="/excel-to-pdf" className="text-indigo-600 hover:underline">Convertify's free tool</Link> in any web browser.
              </li>
              <li>
      ...
      <HowToSchema
        toolName="Convert Excel to PDF Free (No Software)"
        description="Convert XLS and XLSX spreadsheets to PDF while keeping charts, formulas, and formatting intact. No Excel required."
        steps={howToSteps}
      />

...
const seoData = toolSeoData["compare-pdf"]
...
export const metadata: Metadata = {
    ...
    alternates: {
        canonical: "https://convertify.work/compare-pdf",
    },
    openGraph: {
        title: seoData.title,
        description: seoData.description,
        ...
        <div className="flex flex-col items-center">
            ...
            <BreadcrumbSchema
                items={[
                    ...
                    { name: "Compare PDF", url: "/compare-pdf" }
                ]}
            />
            <SoftwareApplicationSchema
                toolName="Convertify PDF Comparison Tool"
            ...
            {seoData.howToSteps && (
                <HowToSchema
                    ...
                    description="Learn how to compare two PDF files side-by-side and highlight differences online with Convertify."
            ...
            <ToolDeepGuide toolSlug="compare-pdf" />

            <RelatedUseCases toolHref="/compare-pdf" />

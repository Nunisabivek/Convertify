...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://convertify.work/how-to-convert-jpg-to-pdf-iphone",
  },
  openGraph: {
    title: "How to Convert JPG to PDF on iPhone - Complete Guide 2026",
    description: "Turn iPhone photos into PDF documents instantly. Perfect for scanning documents, receipts, and creating photo albums on iOS.",
    url: "/how-to-convert-jpg-to-pdf-iphone",
    images: [
      {
        url: "/images/og-banner.png",
        width: 1200,
        height: 630,
        alt: "How to Convert JPG to PDF on iPhone - Complete Guide 2026",
      },
    ],
  },
}
    ...
    <div className="flex flex-col items-center">
      ...
      <BreadcrumbSchema 
        items={[
          ...
          { name: "Convert JPG to PDF on iPhone (No App Needed)", url: "/how-to-convert-jpg-to-pdf-iphone" }
        ]}
      />
      ...
      <section className="w-full py-12 bg-gradient-to-b from-blue-50 to-white">
        <div className="max-w-4xl mx-auto px-4">
          <h1 className="text-4xl md:text-5xl font-extrabold text-slate-900 mb-4 text-center">
            Convert JPG to PDF on iPhone (No App Needed)
          </h1>
          <p className="text-xl text-slate-600 max-w-3xl mx-auto mb-8 text-center">
            Turn iPhone photos into PDF documents instantly. Perfect for scanning documents, receipts, and creating photo albums on iOS.
          </p>
      ...
      <section className="w-full py-12 bg-white">
        <div className="max-w-4xl mx-auto px-4">
          <div className="prose prose-lg max-w-none">
            ...
            <ol>
              <li>
                <strong>Open the Tool:</strong> Visit <Link href="/jpg-to-pdf" className="text-indigo-600 hover:underline">Convertify's free tool</Link> in any web browser.
              </li>
              <li>
      ...
      <HowToSchema
        toolName="Convert JPG to PDF on iPhone (No App Needed)"
        description="Turn iPhone photos into PDF documents instantly. Perfect for scanning documents, receipts, and creating photo albums on iOS."
        steps={howToSteps}
      />

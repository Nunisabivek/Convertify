...
export const metadata: Metadata = {
    title: appToolTitle('split-pdf', seoData.title),
...
export default function Page() {
    if (IS_MOBILE_BUILD) return <MobileToolFrame toolId="split-pdf"><SplitPdfClient /></MobileToolFrame>
    ...
    return (
        <div className="flex flex-col items-center">
            ...
            {/* Long-form guide */}
            <ToolDeepGuide toolSlug="split-pdf" toolName="PDF Splitter" />

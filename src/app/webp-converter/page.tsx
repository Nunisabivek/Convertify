...
export const metadata: Metadata = {
    title: appToolTitle('webp-converter', "WebP Converter - Convert Images to/from WebP Free | Convertify"),
...
export default function Page() {
    if (IS_MOBILE_BUILD) return <MobileToolFrame toolId="webp-converter"><WebpConverterClient /></MobileToolFrame>

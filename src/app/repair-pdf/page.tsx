    ...
    return (
        <div className="flex flex-col items-center">
            ...
            <SoftwareApplicationSchema
                toolName="Convertify PDF Repair Tool"
                toolSlug="repair-pdf"
                description={seoData.description}
            />
            ...
            {seoData.howToSteps && (
                <HowToSchema
                    toolName="Repair PDF"
                    description="Learn how to repair corrupted PDF files online with Convertify."
            ...
            <ToolDeepGuide toolSlug="repair-pdf" toolName="Repair PDF Online" />
            <RelatedUseCases toolHref="/repair-pdf" />

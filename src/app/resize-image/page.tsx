...
export const metadata: Metadata = {
    title: appToolTitle('resize-image', "Resize Image - Change Image Dimensions Free Online | Convertify"),
...
export default function Page() {
    if (IS_MOBILE_BUILD) return <MobileToolFrame toolId="resize-image"><ResizeImageClient /></MobileToolFrame>

    const relatedBlogSlugs = getBlogPostsForTool('resize-image')

    ...
    if (converted.length > 0) {
        return (
            <div className="container mx-auto py-12 max-w-4xl px-4 text-center">
                ...
                <Button size="xl" onClick={downloadAll} className="bg-purple-600 hover:bg-purple-700 mb-4">
            ...
            {files.length === 0 ? (
                ...
                <div className="space-y-6">
                    <div className="bg-white rounded-xl border p-6">
                        ...
                        <Button size="xl" onClick={convertToPng} disabled={isProcessing} className="w-full bg-purple-600 hover:bg-purple-700">
                            {isProcessing ? (
                    ...
                    <div className="text-center">
                        <FileUploader onFilesSelected={handleFilesSelected} multiple={true} accept={{ "image/jpeg": [".jpg", ".jpeg"] }} />
                    </div>
                </div>
            )}
        </div>

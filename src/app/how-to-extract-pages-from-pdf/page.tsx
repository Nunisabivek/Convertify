...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://convertify.work/how-to-extract-pages-from-pdf",
  },
  openGraph: {
    title: "How to Extract Specific Pages from PDF Document",
    description: "Extract selected pages from PDF file online. Choose specific pages or page ranges. Download as new PDF instantly.",
    url: "/how-to-extract-pages-from-pdf",
    images: [
      {
        url: "/images/og-banner.png",
        width: 1200,
        height: 630,
        alt: "How to Extract Specific Pages from PDF Document",
      },
    ],
  },
}
    ...
    <div className="flex flex-col items-center">
      ...
      <BreadcrumbSchema 
        items={[
          ...
          { name: "Extract Specific Pages from PDF", url: "/how-to-extract-pages-from-pdf" }
        ]}
      />
      ...
      <section className="w-full py-12 bg-gradient-to-b from-blue-50 to-white">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <p className="text-xl text-slate-600 max-w-3xl mx-auto mb-8 text-center">
            Extract selected pages from PDF file online. Choose specific pages or page ranges. Download as new PDF instantly.
          </p>
      ...
      <HowToSchema
        toolName="Extract Specific Pages from PDF"
        description="Extract selected pages from PDF file online. Choose specific pages or page ranges. Download as new PDF instantly."
        steps={howToSteps}
      />
